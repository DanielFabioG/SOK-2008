...
Avslutningsvis ser vi at arbeidstilbudet etter at individet fikk subsidiert barnepass er større fordi $h_1 > h_2$ der individet blir å tilbringe mer tid på arbeid, dette kan virke ulogisk men om du tenker at venstre på $x-aksen = > = større = bedre$, så gir det mening.
...
Ser man på arbeids-raten (prosenten) så er det Ungarn som har færrest kvinner ansatt med yngre barn og Litauen som har flest.
...
På lengre sikt er det de nordiske landene som har best ansettelsesprosent med Danmark og Finland på toppen, de begge ligger henholdsvis med en 100% foreldrepermisjon mellom 25-40 uker.
