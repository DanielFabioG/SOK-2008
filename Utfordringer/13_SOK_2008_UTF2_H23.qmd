...
$R^2$ sier at 4 prosent av arbeidsledigheten kan forklares av organisasjonsgraden innenlands og 7 prosent av arbeidsledigheten kan forklares av organisasjonsgraden for utenlandsfødte. Normalt betyr dette at det ikke finnes noen statistisk sammenheng mellom de to variablene, og at det ikke er noen sammenheng.
...
Når man ser på organisasjonsgraden i en multippel lineær regresjonsanalyse kan man se enstørre korrelasjon hvor 41% av arbeidsledigheten kan forklares av organisasjonsgraden. Det man også kan se er at p-verdien til innenlandsfødte og utenlandsfødte er signifikant, som betyr at nullhypotesen ikke kan forkastes. Hvis det hadde vært 0 arbeidsledighet ville intercept forklart at det fortsatt er 24.6 prosent organisasjonsgrad.
